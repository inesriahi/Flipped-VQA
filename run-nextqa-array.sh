...
--max_seq_len 256 --batch_size 8 --epochs 15 --warmup_epochs 2 --bias 3.5 --tau 100. --max_feats 10 --dataset nextqa \
--blr 9e-2 --weight_decay 0.14 --output_dir ./checkpoint/nextqa/${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID} --accum_iter 2 --vaq --qav --is_generation_task"
